      ...
      <div className="bg-gray-900 py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 text-center lg:px-8">
          <div className="mx-auto max-w-2xl">
            <h2 className="text-2xl font-bold tracking-tight text-white sm:text-4xl">Team Roster</h2>
          </div>
          <ul
            role="list"
            ...
            {players.map((player) => (
              <li key={player.player_id} className="rounded-2xl bg-gray-800 px-8 py-10">
                ...
                >
                  <button
                      type="button"
                      className="rounded-full bg-red-800 px-4 py-2.5 text-sm font-semibold text-white shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-800 mt-3"
                    >
                      PLAYER STATS 
                  </button>
                  </Link>
