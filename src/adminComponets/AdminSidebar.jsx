...
const navigation = [
  ...
  { name: 'Estadisticas', href: '/admin-home/CreatePlayersMatchStats',icon: CalendarIcon, current: false },
]
        ...
        <div className="lg:pl-72">
          <div className="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-200 bg-white px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
              ...
              onClick={() => setLogoutConfirmOpen(true)}>Sign Out
              </button>
                      </MenuItem>
                  </MenuItems>
                </Menu>
                <Dialog open={logoutConfirmOpen} onClose={() => setLogoutConfirmOpen(false)} className="relative z-50">
        <DialogBackdrop className="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity" />
        <div className="fixed inset-0 flex items-center justify-center p-4">
          <DialogPanel className="w-full max-w-sm rounded bg-white p-6">
            <Dialog.Title className="text-lg font-medium text-gray-900">Confirm Logout</Dialog.Title>
            <Dialog.Description className="mt-2 text-sm text-gray-500">
              Are you sure you want to log out?
            </Dialog.Description>
            <div className="mt-4 flex justify-end">
              <button
                className="mr-2 px-4 py-2 text-sm font-medium text-gray-700 bg-gray-100 hover:bg-gray-200 rounded"
